...
public class MySparkJob {
  private static final int ROWS_OF_PARTITIONS = 1000;
...
//
//    String outputPath = "file:///Users/kejiang/Developer/WordCount/spark/anagram-" + System.currentTimeMillis() + "/";
//    anagramGroups.saveAsTextFile(outputPath);
//
//    sc.stop();
//  }
//
...
//  }
  ...
  public static void main(String[] args) {
    ...
    String outputPath = "file:///Users/kejiang/Developer/WordCount/spark/palindrome-" + System.currentTimeMillis() + "/";
